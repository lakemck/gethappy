...
function getInfoWindowDetails(location){
        var contentString = '<div id="infoWindowBox">' +
                            '<h3 id="firstHeading" class="infoWindowTitle">' + barTitle[i] + '</h3>'+
                                ...
                                '<div class="directionsLinkMap"><a href="http://maps.google.com/maps?saddr=<?php echo $googDestLat.','.$googDestLng; ?>&daddr=<?php echo $startLat.','.$startLng; ?>" target="blank" class="getDirectionsLink"><i class="fa fa-location-arrow"></i></a></div>'+
                              '</div>';
